document.getElementById('editCategoryModal').addEventListener('show.bs.modal', function (e) {
    ...
    document.getElementById('editCategoryForm').action = '/admin/products/categories/' + btn.dataset.id + '/edit';
...
document.getElementById('editProductModal').addEventListener('show.bs.modal', function (e) {
    const btn = e.relatedTarget;
    document.getElementById('editProductForm').action = '/admin/products/' + btn.dataset.id + '/edit';
